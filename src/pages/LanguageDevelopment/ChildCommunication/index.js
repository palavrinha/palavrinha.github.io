...
export default class ChildCommunication extends React.Component {
            ...
            <div className="text-container">
                ...
                <Accordion defaultActiveKey={['0']} alwaysOpen>
                    <Accordion.Item eventKey="0">
                        <Accordion.Header  ref={accd => this.accd = accd}>Linguagem oral</Accordion.Header>
                        <Accordion.Body>
                            <span>
                    ...
                    <Accordion.Item eventKey="2">
                        ...
                        <Accordion.Body>
                            ...
                            <span>
                                <div className="tab-link" onClick={() => this.props.onTabChange('esperado-por-idade')}>🡥 <u>O que é esperado por idade no desenvolvimento da linguagem oral?</u></div>
                            </span>
                            <span>
                                <div className="tab-link" onClick={() => this.props.onTabChange('sinais-de-alerta')}>🡥 <u>Principais sinais de alerta</u></div>
                            </span>
                        </Accordion.Body>
                    </Accordion.Item>
                </Accordion>
